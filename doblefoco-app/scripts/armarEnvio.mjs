...
if (ciclo && armados) {
    ...
    const lineas = [
        ...
        '2. **«Fiscalizar al poder» se resolvía de tres formas distintas** en Chocó 7 Días,',
        '   Noticias Uno y La Silla Vacía. **DECIDIDA el 2026-08-18: regla del polo fijo.**',
        '   Fiscalizar no es evidencia de orientación; lo que sí lo es, la asimetría a través',
        '   del cambio de gobierno. Va explicada en el CONTEXTO que se pega al revisor.',
